...
! function(a, b, c) {
    ...
    e.prototype = {
        ...
        init: function() {
            var b = this;
            return b.config = a.extend({}, b.defaults, b.options, b.metadata), "" !== b.config.filter && (b.$nav = b.$nav.filter(b.config.filter)), b.$nav.on("click.onePageNav", a.proxy(b.handleClick, b)), b.getPositions(), b.bindInterval(), b.$win.on("resize.onePageNav", a.proxy(b.getPositions, b)), b.scrollChange(), this
        },
        adjustNav: function(b, c) {
            var d = c.find("a").attr("href");
            a(".navbar-nav").find("> li." + b.config.currentClass).removeClass(b.config.currentClass), a(".navbar-nav").find('a[href="' + d + '"]').each(function() {
                a(this).parent().addClass(b.config.currentClass)
            })
        },
        ...
        getPositions: function() {
            var c, d, e, b = this;
            b.$nav.each(function() {
                c = b.getHash(a(this)), e = a("#" + c), e.length && (d = e.offset().top, b.sections[c] = Math.round(d) - b.config.scrollOffset)
            })
        },
        ...
        handleClick: function(c) {
            ...
            if ("#" != e.attr("href")) {
                var g = "#" + d.getHash(e);
                /#view-/i.test(g) || (d.config.begin && d.config.begin(), d.adjustNav(d, f), d.unbindInterval(), a.scrollTo(g, d.config.scrollSpeed, {
                    axis: "y",
